package com.justpass.app.widget
...
class AttendanceWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_REFRESH = "com.justpass.app.ACTION_REFRESH"
    ...
    override fun onEnabled(context: Context) {
        ...
        com.justpass.app.worker.AttendanceRefreshWorker.schedulePeriodicRefresh(context)
    }

    override fun onDisabled(context: Context) {
        // Cancel refresh when last widget is removed
        com.justpass.app.worker.AttendanceRefreshWorker.cancelPeriodicRefresh(context)
    }
}
