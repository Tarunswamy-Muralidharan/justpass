...
import com.justpass.app.widget.AttendanceWidgetReceiver
    ...
    override suspend fun doWork(): Result {
        try {
            ...
            when (val result = repository.refreshAttendance()) {
                ...
                is com.justpass.app.data.repository.Result.Error -> {
                ...
                is com.justpass.app.data.repository.Result.Loading -> {
                    scheduleNextRefresh(context)
                    return Result.success()
                }
            }
